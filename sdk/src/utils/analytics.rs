...
pub async fn equation5(feedstock_data: &[Record], cod_lab_sheet: f64) -> ValueSet {
    ...
    ValueSet::new(result, data_timestamp)
}
...
pub async fn equation10(bde: Vec<f64>, ch4: Vec<f64>, calc_data: &[Record]) -> ValueSet {
    ...
    ValueSet::new(result, daily_f_mo.1)
}
...
pub async fn equation12(calc_data: &[Record]) -> ValueSet {
    ...
    ValueSet::new(result, daily_calc_data.1)
}
...
impl Record {
    pub fn new(date: NaiveDateTime, value: f64, company: String, sensor_id: String, raw: Option<Value>) -> Self {
        Record {
            sensor_id,
            data_timestamp: date,
            sum: value,
